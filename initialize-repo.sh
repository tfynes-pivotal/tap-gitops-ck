...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-ck
echo     http://github.com/tfynes-pivotal/tap-gitops-ck
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-ck --public
git remote add origin http://github.com/tfynes-pivotal/tap-gitops-ck
git branch -M main
